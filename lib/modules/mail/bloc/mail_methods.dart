...
class MailMethods {
  ...
  Future<List<Folder>> getFolders() async {
    try {
      ...
      if (err is ServerError || err is SocketException) {
        throw err;
      } else {
        print("getFolders err: $err");
        print("getFolders s: $s");
        return null;
      }
    }
  }
  ...
  Future<List<Folder>> refreshFolders() async {
    try {
      ...
      if (err is ServerError || err is SocketException) {
        ...
        print("refreshFolders err: $err");
        print("refreshFolders s: $s");
        return null;
      }
    }
  }
  ...
  Future<void> _setMessagesInfoToFolder() async {
    ...
    try {
      ...
      if (err is ServerError || err is SocketException) {
        ...
        print("_setMessagesInfoToFolder err: $err");
        print("_setMessagesInfoToFolder s: $s");
        return null;
      }
    }
  }
