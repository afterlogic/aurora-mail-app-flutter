  ...
  void _login(BuildContext context) {
    if (Platform.isIOS) {
      if (_showHostField && hostCtrl.text.isEmpty) {
        return _showError(context, S.of(context).error_login_input_hostname);
      } else if (emailCtrl.text.isEmpty) {
        return _showError(context, S.of(context).error_login_input_email);
      } else if (passwordCtrl.text.isEmpty) {
        return _showError(context, S.of(context).error_login_input_password);
      }
    } else {
          ...
          listener: (context, state) {
            if (state is NeedsHost) {
              ...
              showSnack(
                ...
                msg: S.of(context).error_login_auto_discover,
              );
            }
