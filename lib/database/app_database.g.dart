...
class $ContactInfosTable extends ContactInfos
  ...
  late final GeneratedColumn<bool> hasBody = GeneratedColumn<bool>(
      ...
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('CHECK ("has_body" IN (0, 1))'),
      defaultValue: Constant(false));
  static const VerificationMeta _needsUpdateMeta =
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'contact_infos';
  @override
  ...
  ContactInfoRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ContactInfoRow(
      ...
      hasBody: attachedDatabase.typeMapping
          .read(DriftSqlType.bool, data['${effectivePrefix}has_body'])!,
      needsUpdate: attachedDatabase.typeMapping
          .read(DriftSqlType.bool, data['${effectivePrefix}needs_update'])!,
    );
  }
...
class ContactInfoRow extends DataClass implements Insertable<ContactInfoRow> {
  ...
  ContactInfoRow copyWithCompanion(ContactInfosCompanion data) {
    return ContactInfoRow(
      sqliteId: data.sqliteId.present ? data.sqliteId.value : this.sqliteId,
      userLocalId:
          data.userLocalId.present ? data.userLocalId.value : this.userLocalId,
      ...
      hasBody: data.hasBody.present ? data.hasBody.value : this.hasBody,
      needsUpdate:
          data.needsUpdate.present ? data.needsUpdate.value : this.needsUpdate,
    );
  }
...
class $$ContactInfosTableFilterComposer
  ...
  ColumnFilters<bool> get needsUpdate => $composableBuilder(
      column: $table.needsUpdate, builder: (column) => ColumnFilters(column));
}
...
class $$ContactInfosTableOrderingComposer
  ...
  ColumnOrderings<bool> get needsUpdate => $composableBuilder(
      column: $table.needsUpdate, builder: (column) => ColumnOrderings(column));
}
...
class $$ContactInfosTableAnnotationComposer
  ...
  GeneratedColumn<bool> get needsUpdate => $composableBuilder(
      column: $table.needsUpdate, builder: (column) => column);
}
...
class $$ContactInfosTableTableManager extends RootTableManager<
    ...
    (
      ContactInfoRow,
      BaseReferences<_$AppDatabase, $ContactInfosTable, ContactInfoRow>
    ),
    ContactInfoRow,
    PrefetchHooks Function()> {
  $$ContactInfosTableTableManager(_$AppDatabase db, $ContactInfosTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<String?> eTag = const Value.absent(),
            Value<bool> hasBody = const Value.absent(),
            Value<bool> needsUpdate = const Value.absent(),
          }) =>
