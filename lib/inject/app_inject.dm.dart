...
class AppInjectorImpl extends AppInjector {
  ...
  CryptoStorage get _getCryptoStorage => _cryptoStorage ??=
      _cryptoModule.cryptoStorage(_getFlutterSecureStorage, _getPgpKeyDao);
  ...
  PgpSettingsBloc pgpSettingsBloc() => PgpSettingsBloc(
        _getCryptoStorage,
        _getPgpWorker,
      );
