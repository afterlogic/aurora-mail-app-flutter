...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(storeName) =>
      "Uygulama doğrulaması başarısız oldu. Lütfen en son sürümü ${storeName}’dan yükleyin.";

  static String m2(organizer) => "Organizatör: ${organizer}";

  static String m4(emails) => "BCC: ${emails}";

  static String m5(emails) => "CC: ${emails}";

  static String m6(emails) => "Gönderen: ${emails}";

  static String m7(date) => "Gönderildi: ${date}";

  static String m8(subject) => "Konu: ${subject}";

  static String m9(emails) => "Alıcı: ${emails}";

  static String m10(time, from) => "${time},tarihinde ${from} yazdı:";

  static String m11(contact) => "${contact} silmek istediğinize emin misiniz?";
  ...
  static String m18(path) => "İndiriliyor: ${path}";

  static String m19(path) => "Dosya şuraya indirildi: ${path}";

  static String m20(fileName) => "${fileName} indiriliyor ...";

  static String m21(path) => "Dosya şuraya yüklendi: ${path}";

  static String m22(fileName) => "${fileName} yükleniyor ...";

  static String m23(subject) => "${subject} silmek istediğinize emin misiniz?";

  static String m24(version) => " ${version} versiyonu";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "btn_log_delete_all": MessageLookupByLibrary.simpleMessage("Tümünü sil"),
    ...
    "btn_message_resend": MessageLookupByLibrary.simpleMessage("Tekrar gönder"),
    ...
    "btn_pgp_decrypt": MessageLookupByLibrary.simpleMessage("Şifresini Çöz"),
    ...
    "btn_pgp_undo_pgp": MessageLookupByLibrary.simpleMessage("PGP\'yi geri al"),
    "btn_php_send_all": MessageLookupByLibrary.simpleMessage("Tümünü gönder"),
    "btn_read": MessageLookupByLibrary.simpleMessage("Okunmuş"),
    "btn_resend_push_token": MessageLookupByLibrary.simpleMessage(
      "Push Token\'ı Tekrar Gönder",
    ),
    ...
    "btn_verify_pin": MessageLookupByLibrary.simpleMessage("PIN\'i doğrula"),
    "button_pgp_verify_sign": MessageLookupByLibrary.simpleMessage("Doğrula"),
    ...
    "calendar_event_title": MessageLookupByLibrary.simpleMessage("Etkinlik"),
    ...
    "calendar_input_all_day": MessageLookupByLibrary.simpleMessage("Tüm gün"),
    ...
    "calendar_input_location": MessageLookupByLibrary.simpleMessage("Konum"),
    ...
    "calendar_name_label": MessageLookupByLibrary.simpleMessage("Takvim adı"),
    "calendar_organizer_label": m2,
    "calendar_please_select_calendar": MessageLookupByLibrary.simpleMessage(
      "Lütfen takvim seçin",
    ),
    "calendar_read_permission": MessageLookupByLibrary.simpleMessage("okuma"),
    ...
    "calendar_unsubscribe": MessageLookupByLibrary.simpleMessage(
      "Aboneliği iptal et",
    ),
    "calendar_unsubscribe_from_calendar": MessageLookupByLibrary.simpleMessage(
      "Takvim aboneliğini iptal et",
    ),
    ...
    "contacts_delete_title": MessageLookupByLibrary.simpleMessage("Kişiyi sil"),
    ...
    "contacts_drawer_storage_all": MessageLookupByLibrary.simpleMessage("Tümü"),
    ...
    "contacts_groups_empty": MessageLookupByLibrary.simpleMessage("Grup yok"),
    ...
    "contacts_view_first_name": MessageLookupByLibrary.simpleMessage("İsim"),
    "contacts_view_hide_additional_fields":
        MessageLookupByLibrary.simpleMessage("Ek alanları gizle"),
    "contacts_view_job_title": MessageLookupByLibrary.simpleMessage("Ünvan"),
    "contacts_view_last_name": MessageLookupByLibrary.simpleMessage("Soyisim"),
    "contacts_view_mobile": MessageLookupByLibrary.simpleMessage(
      "Cep Telefonu",
    ),
    "contacts_view_name": MessageLookupByLibrary.simpleMessage("İsim"),
    "contacts_view_nickname": MessageLookupByLibrary.simpleMessage(
      "Takma İsim",
    ),
    ...
    "contacts_view_province": MessageLookupByLibrary.simpleMessage("Eyalet"),
    ...
    "contacts_view_web_page": MessageLookupByLibrary.simpleMessage(
      "Web Sayfası",
    ),
    ...
    "error_contact_pgp_key_will_not_be_valid":
        MessageLookupByLibrary.simpleMessage("PGP anahtarı geçerli olmayacak"),
    ...
    "error_invalid_pin": MessageLookupByLibrary.simpleMessage("Geçersiz PIN"),
    ...
    "error_server_rest_invalid_credentials":
        MessageLookupByLibrary.simpleMessage("REST geçersiz kimlik bilgileri"),
    ...
    "input_message_search_since": MessageLookupByLibrary.simpleMessage(
      "İtibaren",
    ),
    "input_message_search_text": MessageLookupByLibrary.simpleMessage("Metin"),
    "input_message_search_till": MessageLookupByLibrary.simpleMessage("Kadar"),
    ...
    "label_contacts_were_imported_successfully":
        MessageLookupByLibrary.simpleMessage("Kişiler başarıyla içe aktarıldı"),
    "label_device_id_copied_to_clip_board":
        MessageLookupByLibrary.simpleMessage("Cihaz kimliği panoya kopyalandı"),
    ...
    "label_encryption_password_for_pgp_key":
        MessageLookupByLibrary.simpleMessage("PGP anahtarı için gerekli şifre"),
    ...
    "label_token_storing_status": MessageLookupByLibrary.simpleMessage(
      "Token saklama durumu",
    ),
    "label_token_successful": MessageLookupByLibrary.simpleMessage("Başarılı"),
    ...
    "messages_list_app_bar_mail": MessageLookupByLibrary.simpleMessage(
      "E-posta",
    ),
    "messages_list_app_bar_search": MessageLookupByLibrary.simpleMessage("Ara"),
    "messages_list_app_bar_settings": MessageLookupByLibrary.simpleMessage(
      "Ayarlar",
    ),
    "messages_no_receivers": MessageLookupByLibrary.simpleMessage("Alıcı yok"),
    ...
    "settings_accounts_relogin": MessageLookupByLibrary.simpleMessage(
      "Hesaba tekrar giriş yap",
    ),
    "settings_common": MessageLookupByLibrary.simpleMessage("Genel"),
    "settings_dark_theme": MessageLookupByLibrary.simpleMessage("Tema"),
    "settings_dark_theme_dark": MessageLookupByLibrary.simpleMessage("Koyu"),
    "settings_dark_theme_light": MessageLookupByLibrary.simpleMessage("Açık"),
    ...
    "tfa_input_backup_code": MessageLookupByLibrary.simpleMessage("Yedek kod"),
    ...
    "tfa_label": MessageLookupByLibrary.simpleMessage("İki Faktörlü Doğrulama"),
    ...
    "tfa_label_hint_security_options": MessageLookupByLibrary.simpleMessage(
      "Mevcut güvenlik seçenekleri",
    ),
    "tfa_label_trust_device": MessageLookupByLibrary.simpleMessage(
      "Her şey hazır",
    ),
    "week_titles": MessageLookupByLibrary.simpleMessage("Pt,Sa,Ça,Pe,Cu,Ct,Pz"),
  };
}
