...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(storeName) =>
      "App-Überprüfung fehlgeschlagen. Bitte installieren Sie die neueste Version aus dem ${storeName}.";

  static String m1(calendarName) =>
      "Sind Sie sicher, dass Sie den Kalender ${calendarName} löschen möchten?";

  static String m2(organizer) => "Organisator: ${organizer}";

  static String m3(calendarName) =>
      "Sind Sie sicher, dass Sie den Kalender ${calendarName} abbestellen möchten?";

  static String m4(emails) => "BCC: ${emails}";

  static String m5(emails) => "CC: ${emails}";

  static String m6(emails) => "Von: ${emails}";

  static String m7(date) => "Gesendet: ${date}";

  static String m8(subject) => "Betreff: ${subject}";

  static String m9(emails) => "An: ${emails}";

  static String m10(time, from) => "Am ${time} schrieb ${from}:";
  ...
  static String m18(path) => "Herunterladen nach ${path}";

  static String m19(path) => "Datei heruntergeladen nach: ${path}";

  static String m20(fileName) => "${fileName} wird heruntergeladen...";

  static String m21(path) => "Datei hochgeladen nach: ${path}";

  static String m22(fileName) => "${fileName} wird hochgeladen...";

  static String m23(subject) =>
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "btn_add_account": MessageLookupByLibrary.simpleMessage("Konto hinzufügen"),
    ...
    "btn_hide_details": MessageLookupByLibrary.simpleMessage(
      "Details ausblenden",
    ),
    "btn_log_delete_all": MessageLookupByLibrary.simpleMessage("Alle löschen"),
    ...
    "btn_message_resend": MessageLookupByLibrary.simpleMessage("Erneut senden"),
    ...
    "btn_pgp_decrypt": MessageLookupByLibrary.simpleMessage("Entschlüsseln"),
    "btn_pgp_download_all": MessageLookupByLibrary.simpleMessage(
      "Alle herunterladen",
    ),
    "btn_pgp_encrypt": MessageLookupByLibrary.simpleMessage("Verschlüsseln"),
    ...
    "btn_pgp_undo_pgp": MessageLookupByLibrary.simpleMessage(
      "PGP rückgängig machen",
    ),
    ...
    "btn_show_details": MessageLookupByLibrary.simpleMessage(
      "Details anzeigen",
    ),
    "btn_show_email_in_light_theme": MessageLookupByLibrary.simpleMessage(
      "E-Mail im hellen Design anzeigen",
    ),
    "btn_to_spam": MessageLookupByLibrary.simpleMessage("Als Spam markieren"),
    ...
    "button_pgp_verify_sign": MessageLookupByLibrary.simpleMessage(
      "Verifizieren",
    ),
    ...
    "calendar_color_label": MessageLookupByLibrary.simpleMessage("Farbe"),
    ...
    "calendar_event_title": MessageLookupByLibrary.simpleMessage("Ereignis"),
    ...
    "calendar_input_all_day": MessageLookupByLibrary.simpleMessage("Ganztägig"),
    ...
    "calendar_name_label": MessageLookupByLibrary.simpleMessage("Kalendername"),
    "calendar_organizer_label": m2,
    "calendar_please_select_calendar": MessageLookupByLibrary.simpleMessage(
      "Bitte Kalender auswählen",
    ),
    "calendar_read_permission": MessageLookupByLibrary.simpleMessage("lesen"),
    ...
    "calendar_unsubscribe": MessageLookupByLibrary.simpleMessage("Abbestellen"),
    ...
    "contacts_add": MessageLookupByLibrary.simpleMessage("Kontakt hinzufügen"),
    ...
    "contacts_drawer_storage_all": MessageLookupByLibrary.simpleMessage("Alle"),
    ...
    "contacts_edit": MessageLookupByLibrary.simpleMessage("Kontakt bearbeiten"),
    ...
    "contacts_empty": MessageLookupByLibrary.simpleMessage("Keine Kontakte"),
    ...
    "contacts_groups_empty": MessageLookupByLibrary.simpleMessage(
      "Keine Gruppen",
    ),
    ...
    "contacts_list_its_me_flag": MessageLookupByLibrary.simpleMessage(
      "Das bin ich!",
    ),
    ...
    "contacts_view_address": MessageLookupByLibrary.simpleMessage("Adresse"),
    ...
    "contacts_view_business_phone": MessageLookupByLibrary.simpleMessage(
      "Geschäftliches Telefon",
    ),
    "contacts_view_city": MessageLookupByLibrary.simpleMessage("Stadt"),
    "contacts_view_company": MessageLookupByLibrary.simpleMessage(
      "Unternehmen",
    ),
    "contacts_view_country": MessageLookupByLibrary.simpleMessage(
      "Land/Region",
    ),
    "contacts_view_department": MessageLookupByLibrary.simpleMessage(
      "Abteilung",
    ),
    ...
    "contacts_view_first_name": MessageLookupByLibrary.simpleMessage("Vorname"),
    "contacts_view_hide_additional_fields":
        MessageLookupByLibrary.simpleMessage("Zusätzliche Felder ausblenden"),
    "contacts_view_job_title": MessageLookupByLibrary.simpleMessage(
      "Berufsbezeichnung",
    ),
    "contacts_view_last_name": MessageLookupByLibrary.simpleMessage("Nachname"),
    ...
    "contacts_view_nickname": MessageLookupByLibrary.simpleMessage("Spitzname"),
    ...
    "contacts_view_province": MessageLookupByLibrary.simpleMessage(
      "Bundesland/Provinz",
    ),
    ...
    "contacts_view_section_home": MessageLookupByLibrary.simpleMessage(
      "Zuhause",
    ),
    "contacts_view_section_key": MessageLookupByLibrary.simpleMessage(
      "Schlüssel",
    ),
    ...
    "contacts_view_web_page": MessageLookupByLibrary.simpleMessage("Webseite"),
    "contacts_view_zip": MessageLookupByLibrary.simpleMessage("Postleitzahl"),
    ...
    "error_invalid_pin": MessageLookupByLibrary.simpleMessage(
      "Ungültiger Code",
    ),
    ...
    "error_server_helpdesk_unactivated_user":
        MessageLookupByLibrary.simpleMessage("Deaktivierter Helpdesk-Benutzer"),
    ...
    "error_server_rest_account_find_failed":
        MessageLookupByLibrary.simpleMessage("REST-Kontosuche fehlgeschlagen"),
    "error_server_rest_api_disabled": MessageLookupByLibrary.simpleMessage(
      "REST-API deaktiviert",
    ),
    ...
    "error_unknown": MessageLookupByLibrary.simpleMessage("Unbekannter Fehler"),
    ...
    "fido_label_success": MessageLookupByLibrary.simpleMessage("Erfolgreich"),
    ...
    "hint_pgp_your_keys": MessageLookupByLibrary.simpleMessage(
      "Ihre Schlüssel",
    ),
    ...
    "input_2fa_pin": MessageLookupByLibrary.simpleMessage("Bestätigungscode"),
    "input_message_search_since": MessageLookupByLibrary.simpleMessage("Seit"),
    "input_message_search_text": MessageLookupByLibrary.simpleMessage("Text"),
    "input_message_search_till": MessageLookupByLibrary.simpleMessage("Bis"),
    "input_self_destructing_add_digital_signature":
        MessageLookupByLibrary.simpleMessage("Digitale Signatur hinzufügen"),
    ...
    "label_contacts_were_imported_successfully":
        MessageLookupByLibrary.simpleMessage("Kontakte erfolgreich importiert"),
    ...
    "label_message_yesterday": MessageLookupByLibrary.simpleMessage("Gestern"),
    ...
    "label_pgp_encrypt": MessageLookupByLibrary.simpleMessage("Verschlüsseln"),
    ...
    "label_pgp_share_warning": MessageLookupByLibrary.simpleMessage("Warnung"),
    ...
    "label_self_destructing_not_sign_data":
        MessageLookupByLibrary.simpleMessage("Wird die Daten nicht signieren."),
    ...
    "label_token_failed": MessageLookupByLibrary.simpleMessage(
      "Fehlgeschlagen",
    ),
    "label_token_storing_status": MessageLookupByLibrary.simpleMessage(
      "Token-Speicherstatus",
    ),
    "label_token_successful": MessageLookupByLibrary.simpleMessage(
      "Erfolgreich",
    ),
    ...
    "login_input_password": MessageLookupByLibrary.simpleMessage("Passwort"),
    ...
    "messages_empty": MessageLookupByLibrary.simpleMessage("Keine Nachrichten"),
    "messages_filter_unread": MessageLookupByLibrary.simpleMessage(
      "Ungelesene Nachrichten:",
    ),
    "messages_forward": MessageLookupByLibrary.simpleMessage("Weiterleiten"),
    ...
    "messages_list_app_bar_mail": MessageLookupByLibrary.simpleMessage("Mail"),
    ...
    "messages_no_subject": MessageLookupByLibrary.simpleMessage("Kein Objekt"),
    "messages_reply": MessageLookupByLibrary.simpleMessage("Antworten"),
    "messages_reply_all": MessageLookupByLibrary.simpleMessage(
      "Allen antworten",
    ),
    ...
    "messages_subject": MessageLookupByLibrary.simpleMessage("Objekt"),
    ...
    "settings_accounts_relogin": MessageLookupByLibrary.simpleMessage(
      "Erneut in Konto anmelden",
    ),
    "settings_common": MessageLookupByLibrary.simpleMessage("Allgemein"),
    "settings_dark_theme": MessageLookupByLibrary.simpleMessage("App-Design"),
    "settings_dark_theme_dark": MessageLookupByLibrary.simpleMessage("Dunkel"),
    "settings_dark_theme_light": MessageLookupByLibrary.simpleMessage("Hell"),
    ...
    "settings_sync": MessageLookupByLibrary.simpleMessage("Synchronisation"),
    ...
    "week_titles": MessageLookupByLibrary.simpleMessage("Mo,Di,Mi,Do,Fr,Sa,So"),
  };
}
