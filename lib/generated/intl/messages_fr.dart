...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(storeName) =>
      "Échec de la vérification de l\'application. Veuillez installer la dernière version depuis l\'${storeName}.";

  static String m2(organizer) => "Organisateur : ${organizer}";

  static String m4(emails) => "BCC : ${emails}";

  static String m5(emails) => "CC : ${emails}";

  static String m6(emails) => "De : ${emails}";

  static String m7(date) => "Envoyé : ${date}";

  static String m8(subject) => "Objet : ${subject}";

  static String m9(emails) => "À : ${emails}";

  static String m10(time, from) => "Le ${time}, ${from} a écrit :";

  static String m11(contact) => "Voulez-vous vraiment supprimer ${contact} ?";
  ...
  static String m18(path) => "Téléchargement vers ${path}";

  static String m19(path) => "Fichier téléchargé dans : ${path}";

  static String m20(fileName) => "Téléchargement de ${fileName}...";

  static String m21(path) => "Fichier importé dans : ${path}";

  static String m22(fileName) => "Importer de ${fileName}...";

  static String m23(subject) => "Voulez-vous vraiment supprimer ${subject} ?";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "app_title": MessageLookupByLibrary.simpleMessage("Client de messagerie"),
    "btn_add_account": MessageLookupByLibrary.simpleMessage(
      "Ajouter un compte",
    ),
    ...
    "btn_log_delete_all": MessageLookupByLibrary.simpleMessage(
      "Tout supprimer",
    ),
    ...
    "button_pgp_verify_sign": MessageLookupByLibrary.simpleMessage("Vérifier"),
    ...
    "calendar_event_title": MessageLookupByLibrary.simpleMessage("Événement"),
    ...
    "calendar_input_reminders": MessageLookupByLibrary.simpleMessage("Rappels"),
    ...
    "calendar_read_permission": MessageLookupByLibrary.simpleMessage("lecture"),
    ...
    "compose_body_placeholder": MessageLookupByLibrary.simpleMessage("Message"),
    ...
    "contacts_add": MessageLookupByLibrary.simpleMessage("Ajouter un contact"),
    ...
    "contacts_drawer_storage_all": MessageLookupByLibrary.simpleMessage("Tous"),
    ...
    "contacts_view_company": MessageLookupByLibrary.simpleMessage("Entreprise"),
    ...
    "contacts_view_first_name": MessageLookupByLibrary.simpleMessage("Prénom"),
    ...
    "contacts_view_last_name": MessageLookupByLibrary.simpleMessage(
      "Nom de famille",
    ),
    ...
    "contacts_view_nickname": MessageLookupByLibrary.simpleMessage("Surnom"),
    ...
    "contacts_view_phone": MessageLookupByLibrary.simpleMessage("Téléphone"),
    ...
    "contacts_view_section_key": MessageLookupByLibrary.simpleMessage("Clé"),
    ...
    "contacts_view_street_address": MessageLookupByLibrary.simpleMessage("Rue"),
    "contacts_view_web_page": MessageLookupByLibrary.simpleMessage("Page web"),
    "contacts_view_zip": MessageLookupByLibrary.simpleMessage("Code postal"),
    ...
    "error_contact_pgp_key_will_not_be_valid":
        MessageLookupByLibrary.simpleMessage("La clé PGP ne sera pas valide"),
    ...
    "error_invalid_pin": MessageLookupByLibrary.simpleMessage("Code invalide"),
    ...
    "error_server_incorrect_file_extension":
        MessageLookupByLibrary.simpleMessage("Extension de fichier incorrecte"),
    "error_server_invalid_input_parameter":
        MessageLookupByLibrary.simpleMessage("Paramètre d\'entrée invalide"),
    ...
    "folders_inbox": MessageLookupByLibrary.simpleMessage("Boîte de réception"),
    ...
    "input_2fa_pin": MessageLookupByLibrary.simpleMessage(
      "Code de vérification",
    ),
    "input_message_search_since": MessageLookupByLibrary.simpleMessage(
      "Depuis",
    ),
    "input_message_search_text": MessageLookupByLibrary.simpleMessage("Texte"),
    "input_message_search_till": MessageLookupByLibrary.simpleMessage(
      "Jusqu\'à",
    ),
    "input_self_destructing_add_digital_signature":
        MessageLookupByLibrary.simpleMessage("Ajouter une signature numérique"),
    ...
    "label_contacts_were_imported_successfully":
        MessageLookupByLibrary.simpleMessage("Contacts importés avec succès"),
    ...
    "label_enable_uploaded_message_counter":
        MessageLookupByLibrary.simpleMessage("Compteur de messages téléversés"),
    ...
    "label_pgp_private_key": MessageLookupByLibrary.simpleMessage("Clé privée"),
    ...
    "label_token_storing_status": MessageLookupByLibrary.simpleMessage(
      "Statut de stockage du jeton",
    ),
    "label_token_successful": MessageLookupByLibrary.simpleMessage("Réussi"),
    ...
    "login_input_password": MessageLookupByLibrary.simpleMessage(
      "Mot de passe",
    ),
    ...
    "messages_no_subject": MessageLookupByLibrary.simpleMessage("Aucun objet"),
    ...
    "settings_accounts_relogin": MessageLookupByLibrary.simpleMessage(
      "Se reconnecter au compte",
    ),
    "settings_common": MessageLookupByLibrary.simpleMessage("Général"),
    "settings_dark_theme": MessageLookupByLibrary.simpleMessage(
      "Thème de l\'application",
    ),
    "settings_dark_theme_dark": MessageLookupByLibrary.simpleMessage("Sombre"),
    "settings_dark_theme_light": MessageLookupByLibrary.simpleMessage("Clair"),
    ...
    "settings_sync": MessageLookupByLibrary.simpleMessage("Nouvelles données"),
    ...
    "settings_sync_period_years1": MessageLookupByLibrary.simpleMessage("1 an"),
    ...
    "tfa_button_continue": MessageLookupByLibrary.simpleMessage("Continuer"),
    ...
    "week_titles": MessageLookupByLibrary.simpleMessage("Lu,Ma,Me,Je,Ve,Sa,Di"),
  };
}
