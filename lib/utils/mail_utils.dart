...
class MailUtils {
  ...
  static String wrapInHtmlEditor(
    ...
    String text,
    bool isHtml,
    bool removeForcedHeight,
  ) {
    final theme = Theme.of(context);
    final useCustomBuildStyles = BuildProperty.useCustomInputStyles;
    ...
    return "<!doctype html>" +
        ...
        <html lang="en">
          <head>
            ...
            <style>
              html, body {
                margin: 0;
                overflow-x: hidden;
                padding: ${useCustomBuildStyles ? '0' : '10px'};
          ...
          0.1,
            ...
            ${useCustomBuildStyles ? 'return document.querySelector(".input-area").innerHTML;' : 'return document.querySelector(".body-area").innerHTML;'}
            }
            window.setBodyContent = function (content) {
              ${useCustomBuildStyles ? 'document.querySelector(".input-area").innerHTML=content;' : 'document.querySelector(".body-area").innerHTML=content;'}
            }
            window.setPlain = function () {
              ${useCustomBuildStyles ? 'document.querySelector(".input-area").style.whiteSpace = "pre";' : 'document.querySelector(".body-area").style = "white-space: pre;";'}
            }
            
            window.setHtml = function () {
                ${useCustomBuildStyles ? 'document.querySelector(".input-area").style.whiteSpace = "";' : 'document.querySelector(".body-area").style = "";'}
            }
            </script>
          </head>
          <body>
            ${useCustomBuildStyles ? '<div class="input-area" contenteditable="true"' + (!isHtml ? ' style="white-space: pre;"' : '') + '>$text</div>' : '<div class="body-area" contenteditable="true"' + (!isHtml ? ' style="white-space: pre;"' : '') + '>$text</div>'}
          </body>
        </html>
        """;
  }
        ...
        <html lang="en">
          ...
          <body class="unselectable">
            <div class="container">
              ...
              <div class="selectable email-content">
                <div style="height: 1px; background-color: black; opacity: 0.05; margin: -18px -18px 18px -18px;"></div>
                $body
              </div>
