...
class NotificationsUtils {
  static const MethodChannel _channel = const MethodChannel('notifications_utils');
  ...
  static Future<List<StatusBarNotification>> getActiveNotifications() async {
    ...
    final List activeNotifications = await _channel.invokeMethod('getActiveNotifications');
